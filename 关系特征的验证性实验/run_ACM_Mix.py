...
def main(args):
    NS, feature, labels, num_classes, train_idx, val_idx, test_idx, Relation_feature, feature_dim, Relation_feature_dim = load_ACM_data()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='ACM_R拼A', help='数据集')
