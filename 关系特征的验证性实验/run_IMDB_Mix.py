...
from imdb.imdb_dataloader import  load_IMDB_data
import numpy as np
import random
...
def main(args):
    NS, feature, labels, num_classes, train_idx, val_idx, test_idx, type_mask, Relation_feature, feature_dim, Relation_feature_dim = load_IMDB_data()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='IMDB_R拼A', help='数据集')
