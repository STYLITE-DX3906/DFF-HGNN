...
from data_ARFE_sum import load_Freebase_data
import numpy as np
import random
...
def main(args):
    ...
    g, features, labels, num_classes, train_idx, val_idx, test_idx = load_Freebase_data()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='Freebase_RFE', help='数据集')
